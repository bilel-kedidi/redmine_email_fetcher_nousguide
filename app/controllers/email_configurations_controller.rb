...
class EmailConfigurationsController < ApplicationController
  ...
  def create
    @email_configuration = EmailConfiguration.new(params[:email_configuration].permit!)
  ...
  def update
    ...
    respond_to do |format|
      if @email_configuration.update_attributes(params[:email_configuration].permit!)
